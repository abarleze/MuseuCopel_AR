...
namespace XeirGYA
{
    ...
    {
        //internal Texture2D _iconPrev;
        //internal Texture2D iconPrev
        //{
        //	get { if (_iconPrev == null) _iconPrev = GetIconPrev (); return _iconPrev; }
        //}
        ...
        //	//// find a particular texture using a named reference
        //	//Texture texture = Resources.Load(textureName);
        ...
        {
   //         string texString =
   //             "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAADUExURTg4OLKfjZcAAAAKSURBVAjXY2AAAAACAAHiIbwzAAAAAElFTkSuQmCC";
			////"iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAABGdBTUEAALGPC/xhBQAAAAlwSFlzAAALEwAACxMBAJqcGAAAAAxJREFUCJljsLCwAAABVACpFt5DjAAAAABJRU5ErkJggg==";
        ...
        {
            //string texString =
            //    "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAADUExURcLCwrn3aaQAAAAKSURBVAjXY2AAAAACAAHiIbwzAAAAAElFTkSuQmCC";
            //return BuildTexture(texString, 1, 1);

            return ShowColor (new Color32 (194, 194, 194, 194));
        }
        ...
        internal static Texture2D TintTexture(Texture2D tintTexture, Color tintColor)
        {
            ...
            //Texture2D texture = new Texture2D(tintTexture.width, tintTexture.height, TextureFormat.ARGB32, false);
            //texture = tintTexture;
            ...
            for (int mip = 0; mip < mipCount; ++mip)
            {
                ...
                for (int i = 0; i < texColors.Length; ++i)
                {
                    if (texColors[i].a >= 0.5f) // Do not process transparent
                    {
                        ...
                        //texColors[i] = CombineColors(colors[mip], texColors[i]);		// Solid
                        //texColors[i] = Color.Lerp(texColors[i], colors[mip], 1f);		// Solid
                        //texColors[i] = Color.Lerp(texColors[i], colors[mip], 0.33f);
                    }
                }
        ...
        internal static Texture2D InvertColors(Texture2D invertedTexture)
        {
            ...
            //Texture2D invertedTexture = new Texture2D(texture.width, 
            //	texture.height, 
            //	texture.format, 
        ...
        internal static Texture2D BuildTexture(string base64Text, int x, int y)
        {
            ...
            //texture = EditorGUIUtility.Load("tImage.png") as Texture2D;
        ...
        //internal static void DownloadStaticPreview (AssetStoreAsset searchResult)
        //{
        ...
        {
            //string texString = "";
            string texString =
                "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAADUExURQAAAKd6PdoAAAABdFJOUwBA5thmAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==";
            return BuildTexture(texString, 16, 16);
        }
